...
### Side Items
- [x] DGX Spark deliverable — local AI deployment comparison notes promised to Prof. Introne for the businessman conversation. Full landscape report drafted 4/30 covering DGX Spark, Mac Studio, GPU workstations, cloud. Resent to Prof. Introne 5/14 (he had not seen it).
